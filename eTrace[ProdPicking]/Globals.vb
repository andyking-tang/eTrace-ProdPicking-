Module Globals
    Public eTracePP As eTraceWS.eTraceOracleERP = New eTraceWS.eTraceOracleERP
    Public ERPLogin As eTraceWS.ERPLogin = New eTraceWS.ERPLogin
    Public mydataset As System.Data.DataSet = New System.Data.DataSet
    Public orderno As String
    Public Process As Integer 'different the save template from select template
    Public ID As Integer  'different the create TO from display TO
    Public Header As eTraceWS.ProdPickingStructure = New eTraceWS.ProdPickingStructure
    Public MainFrm As frmMain
    Public PickOrder As System.String
    Public lock, open As Integer
    Public DJQty As Decimal
